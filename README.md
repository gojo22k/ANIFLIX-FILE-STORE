<p align="center">
  <img src="https://envs.sh/nL2.jpg" alt="ANIFLIX-FILE-STORE-BOT Logo">
</p>
<h1 align="center">
  ANIFLIX FILE STORE BOT
</h1>

![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=Welcome+To+ANIFLIX-FILE-STORE-BOT;A+Highly+Advance+File+Store+Bot;Made+By+Yt-@Aniflix_Official!;With+Clone+Feature+Stream/Download+Link;Custom+Url+Shortner+Auto+Delete+Feature;A+Bot+With+Fully+Advanced+Feature!;Must+Give+Credit+To+ANIFLIX;Because+He+Public+The+Paid+Repo;Thank+You!)
</p>
...
- `/batch` : By This Command You Can Generate Multiple File Shareable Link At A Time [Use Like This /batch (first post link)<SPACE ONLY>(last post link)]
...
Copyright ©️ [ANIFLIX](https://telegram.me/ANIFLIX_OFFICIAL)
...
- Telegram Channel : [ANIFLIX OFFICIAL](https://telegram.me/ANIFLIX_OFFICIAL)
- Contact Link : [ANIFLIX](https://telegram.me/Aniflix_Ankit)
- Instagram Id Link : [Ankit](https://instagram.com/gojo22k)
